...
_(You might be able to build from source, I haven't tested if that would work though)_
...
it is **highly** recommended that you add these to your system path environment!
